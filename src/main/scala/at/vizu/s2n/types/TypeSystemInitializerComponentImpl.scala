 ...
 * Phil on 23.10.15.
 */
trait TypeSystemInitializerComponentImpl extends TypeSystemInitializerComponent {

  class TypeSystemInitializerImpl extends TypeSystemInitializer {
    self: ScopeInitializer =>

    private val rootScope: TScope = initScope
